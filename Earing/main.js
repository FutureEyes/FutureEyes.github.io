...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const occluder = await loadGLTF('./asset/models/sparkar-occluder/headOccluder.glb');
    ...
    const glasses = await loadGLTF('./asset/models/glasses1/scene.gltf');
    ...
    const glasses2 = await loadGLTF('./asset/models/glasses2/scene.gltf');
    ...
    const hat1 = await loadGLTF('./asset/models/hat1/scene.gltf');
    ...
    const hat2 = await loadGLTF('./asset/models/hat2/scene.gltf');
    ...
    earringLeft.scene.scale.set(0.045, 0.045, 0.045);
    ...
    earringRight.scene.scale.set(0.045, 0.045, 0.045);
